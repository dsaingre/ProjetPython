...
class Installation(object):
    ...
    def __init__(self, nameTown, INSEECode, postalCode,
                 placeCalled, streetNum, longitude, 
        ...
        """
        Constructor ; needs 28 arguments : 
        - nameInstall : String
        - numInstall : String
        - nameTown : String
        - INSEECode : String
        ...
        self.nbOfDisParkSpot = nbOfDisParkSpot
    ...
    def getNbOfDisParkSpot(self):
            return self.nbOfDisParkSpot
	
    def setNbOfDisParkSpot(self, nbOfDisParkSpot):
            self.nbOfDiskParSpot = nbOfDisParkSpot
    ...
    def __str__(self):
        return "Installation : "+self.INSEECode
